...
public class SAXMessageFormatter
{
    ...
    throws MissingResourceException
  {
    ...
    if (paramLocale != null) {
      localResourceBundle = ResourceBundle.getBundle("org.apache.xerces.impl.msg.SAXMessages", paramLocale);
    } else {
      localResourceBundle = ResourceBundle.getBundle("org.apache.xerces.impl.msg.SAXMessages");
    }
    String str;
    try
    {
 ...
 * Qualified Name:     org.apache.xerces.util.SAXMessageFormatter
