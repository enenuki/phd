...
public class EncodingMap
{
   ...
   * @deprecated
   */
  public static void putIANA2JavaMapping(String paramString1, String paramString2)
  {
    fIANA2JavaMap.put(paramString1, paramString2);
  }
   ...
   * @deprecated
   */
  public static String removeIANA2JavaMapping(String paramString)
  {
    return (String)fIANA2JavaMap.remove(paramString);
  }
  
  /**
   * @deprecated
   */
  public static void putJava2IANAMapping(String paramString1, String paramString2)
  {
    fJava2IANAMap.put(paramString1, paramString2);
  }
   ...
   * @deprecated
   */
  public static String removeJava2IANAMapping(String paramString)
  {
    return (String)fJava2IANAMap.remove(paramString);
  }
 ...
 * Qualified Name:     org.apache.xerces.util.EncodingMap
