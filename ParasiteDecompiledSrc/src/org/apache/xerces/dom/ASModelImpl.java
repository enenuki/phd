  ...
  implements ASModel
{
  ...
  public ASElementDeclaration createASElementDeclaration(String paramString1, String paramString2)
    throws DOMException
  {
    String str = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NOT_SUPPORTED_ERR", null);
    throw new DOMException((short)9, str);
  ...
  public ASAttributeDeclaration createASAttributeDeclaration(String paramString1, String paramString2)
    throws DOMException
  {
    String str = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NOT_SUPPORTED_ERR", null);
    throw new DOMException((short)9, str);
  ...
  public ASNotationDeclaration createASNotationDeclaration(String paramString1, String paramString2, String paramString3, String paramString4)
    throws DOMException
  {
    String str = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NOT_SUPPORTED_ERR", null);
    throw new DOMException((short)9, str);
  ...
  public ASEntityDeclaration createASEntityDeclaration(String paramString)
    throws DOMException
  {
    String str = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NOT_SUPPORTED_ERR", null);
    throw new DOMException((short)9, str);
  ...
  public ASContentModel createASContentModel(int paramInt1, int paramInt2, short paramShort)
 ...
 * Qualified Name:     org.apache.xerces.dom.ASModelImpl
