...
public abstract interface Query
{
  ...
  public abstract Query setLockOptions(LockOptions paramLockOptions);
  
  public abstract Query setLockMode(String paramString, LockMode paramLockMode);
  
  public abstract Query setComment(String paramString);
  
  public abstract Query setFlushMode(FlushMode paramFlushMode);
  
  public abstract Query setCacheMode(CacheMode paramCacheMode);
  ...
  public abstract Query setParameters(Object[] paramArrayOfObject, Type[] paramArrayOfType)
    throws HibernateException;
  
  public abstract Query setParameterList(String paramString, Collection paramCollection, Type paramType)
    throws HibernateException;
  
  public abstract Query setParameterList(String paramString, Collection paramCollection)
    throws HibernateException;
  
  public abstract Query setParameterList(String paramString, Object[] paramArrayOfObject, Type paramType)
    throws HibernateException;
  
  public abstract Query setParameterList(String paramString, Object[] paramArrayOfObject)
    throws HibernateException;
  
  public abstract Query setProperties(Object paramObject)
    throws HibernateException;
  
  public abstract Query setProperties(Map paramMap)
    throws HibernateException;
 ...
 * Qualified Name:     org.hibernate.Query
