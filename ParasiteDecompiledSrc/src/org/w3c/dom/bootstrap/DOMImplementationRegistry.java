...
public final class DOMImplementationRegistry
{
  ...
  public DOMImplementationList getDOMImplementationList(String paramString)
  {
    ...
    new DOMImplementationList()
    {
      ...
      {
        if ((paramAnonymousInt >= 0) && (paramAnonymousInt < this.val$implementations.size())) {
          try
          {
            return (DOMImplementation)this.val$implementations.elementAt(paramAnonymousInt);
          }
    ...
    (InputStream)AccessController.doPrivileged(new PrivilegedAction()
    {
      ...
      public Object run()
      {
        ...
        if (this.val$classLoader == null) {
          ...
          localInputStream = this.val$classLoader.getResourceAsStream(this.val$name);
        }
        return localInputStream;
      }
    });
