  ...
  extends Constants
{
    ...
    throws ArithmeticException
  {
    ...
    {
      d = gamma(paramDouble1) / d;
      d *= gamma(paramDouble2);
    }
    else
    {
      d = gamma(paramDouble2) / d;
      d *= gamma(paramDouble1);
    }
    return d;
  }
    ...
    throws ArithmeticException
  {
    ...
    if (d3 > 33.0D)
    {
      if (paramDouble < 0.0D)
      {
        ...
        d2 = Math.abs(d2);
        d2 = 3.141592653589793D / (d2 * stirlingFormula(d3));
        return -d2;
      }
    ...
    paramDouble -= 2.0D;
    double d1 = Polynomial.polevl(paramDouble, arrayOfDouble1, 6);
    d3 = Polynomial.polevl(paramDouble, arrayOfDouble2, 7);
    return d2 * d1 / d3;
  }
    ...
    throws ArithmeticException
  {
    ...
    {
      d3 = powerSeries(paramDouble1, paramDouble2, paramDouble3);
      return d3;
    }
    ...
    d7 += d3 + logGamma(d1 + d2) - logGamma(d1) - logGamma(d2);
    d7 += Math.log(d6 / d1);
    ...
    throws ArithmeticException
  {
    ...
    double d2 = paramDouble1 * Math.log(paramDouble2) - paramDouble2 - logGamma(paramDouble1);
    ...
    throws ArithmeticException
  {
    ...
    if (paramDouble < 13.0D)
    {
      ...
      paramDouble -= 2.0D;
      d1 = paramDouble * Polynomial.polevl(paramDouble, arrayOfDouble2, 5) / Polynomial.p1evl(paramDouble, arrayOfDouble3, 6);
    ...
    if (paramDouble >= 1000.0D) {
      ...
      d2 += Polynomial.polevl(d1, arrayOfDouble1, 4) / paramDouble;
    }
    return d2;
  }
    ...
    throws ArithmeticException
  {
    ...
    {
      d2 = logGamma(paramDouble1 + paramDouble2) - logGamma(paramDouble1) - logGamma(paramDouble2) + d3 + Math.log(d1);
    ...
    throws ArithmeticException
  {
    ...
    d2 = 1.0D + d2 * Polynomial.polevl(d2, arrayOfDouble, 4);
    if (paramDouble > d1)
    {
 ...
 * Qualified Name:     cern.jet.stat.Gamma
